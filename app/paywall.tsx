...
export default function Paywall() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Stacked before/after cards, not the numbered claim list.
            ...
            using a repackaged app template". A second app in the portfolio,
            packpixel, already owns the numbered-list shape this screen used to
            have, so this one earns its own structure instead: a muted "free
            today" card sits above a distinct accent-toned "lifetime unlock"
            card, and the contrast between the two — not a shared list — is
            what carries the pitch. Same claims, a visibly different page. */}
        ...
        <View style={{ marginTop: spacing["2xl"], gap: spacing.base }}>
          {/* The "before" card: a muted surface describing today, ads and all. */}
          <View
            style={{
          ...
          {/* The "after" card: the app's accent tone, carrying every honest claim
              this purchase can make. Checkmarks, not numbers, because this card
              is describing a single outcome rather than a sequence. */}
          <View
            style={{
